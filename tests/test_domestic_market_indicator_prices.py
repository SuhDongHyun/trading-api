...
class DomesticMarketIndicatorPriceTest(unittest.TestCase):
    """국내 시장 지표의 기간 조회 동작을 검증한다."""
    ...
    def test_rejects_invalid_date_before_requesting_api(self, api_get):
        ...
        with self.assertRaises(ValueError):
            client.get_domestic_market_indicator_prices(
                market="U",
                code="0001",
                start_date="20241301",
                end_date="20240531",
    ...
    def test_requests_date_range_and_returns_prices_in_date_order(self, api_get):
        ...
        result = client.get_domestic_market_indicator_prices(
            market="U",
            code="0001",
            start_date="20240528",
            end_date="20240531",
